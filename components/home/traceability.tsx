  ...
  return (
    <>
      ...
      <section className='bg-[#E7E7E7]'>
        ...
        >
          <h4
            className="text-[26px] text-[rgb(180,20,49)] font-garamond text-center"
          >
        ...
        <div className='text-center flex items-center justify-center '>
            <p className='py-2 max-w-[1000px] '>South American leading supplier of Frozen and Chilled Beef meat cuts, Biggest Market in China, Vietnam and USA. Animal Slaughtering and Processing PLANT 13 & 1372 Argentina and Specialty Food Manufacturing,. Beef products, from Angus and Hereford cattle .</p>
        </div>
      </section>
    </>
  )
